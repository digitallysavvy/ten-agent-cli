...
func Create(name string) error {
	...
	// Set the working directory to the extension folder
	cmd.Dir = filepath.Join("agents", "ten_packages", "extension")
	...
	manifestPath := filepath.Join(cmd.Dir, name, "manifest.json")
